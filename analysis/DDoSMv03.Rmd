...
```{r fn_read_tcad_trace, include=FALSE}
...
packets <- read_csv(pcap_csv_m14, col_types = col_types)
...
# Adding an offset to compensate the pre-initializing of training coefficients.
...
**Note: for log2m=14, packet diversion begins at OW 770. DEFCON uses OWs 769 and 768 as a reference.**
