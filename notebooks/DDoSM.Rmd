...
Convert the delta value from hexadecimal to decimal. 
...
Get the stats for all but the first two OWs under attack: histogram of addresses for each delta value. 
...
It would be interesting to observe what happens **over time**, when we move from OW 770 toward the end of the attack. 
