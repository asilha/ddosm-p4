...
phases.append({"start" : 1+t_len,       "length" : t_len,   "alarms" : 0.0})  # phase 1: detection under safety
phases.append({"start" : 1+2*t_len,     "length" : t_len*8, "alarms" : 0.0})  # phase 2: detection under attack
...
for kvalue in kvalues:
    ...
    fpr=phases[1]["alarms"]/phases[1]["length"]
    print("{:.3f}\t{:6f}\t{:6f}".format(kvalue, tpr, fpr))
